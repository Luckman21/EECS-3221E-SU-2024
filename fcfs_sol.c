...
/* WARNING: This code is used only for you to debug your own FCFS scheduler. You
should NOT use this as a template for the remaining two schedulers. Otherwise, your
codes may not pass plagiarism tests. */
...
#include "sch-helpers.c" /* include header file of all helper functions */
...
/* compares processes pointed to by *aa and *bb by process id, returning -1 if aa < bb, 1 if aa > bb and 0 otherwise. */
